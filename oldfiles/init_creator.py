...
def FUNKTIONSTITEL():
	try:
		return render_template("FACH/ORDNER/HTMLNAME", aktFach="FACH", aktThema="THEMA", zurueckURL="/FACHLINKZURSEITE",  ITS_THEMEN=ITS_THEMEN, AWE_THEMEN=AWE_THEMEN, Kartei=KARTEN_DICT["FACH"]["THEMA"])
	except Exception as e:
		print(str(e))
"""
